...
from xzibit.utils import get_values_from_list_of_dicts, flatten_dict, remove_prefix_from_keys, get_values_for_key, get_path_size, pp
...
class MyConnector(Connector):
    ...
    def generate_rows(self, dataset_schema=None, dataset_partitioning=None,
        ...
        for code_env_info in self.client.list_code_envs():
            ...
            # pp(settings)
            next_code_env['size_megabytes'] = get_path_size_megabytes(next_code_env['path'])
