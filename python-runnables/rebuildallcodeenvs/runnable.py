...
from xzibit.utils import clear_pip_tmp
    ...
    def _process_code_env(self, code_env_info):
        try:
            ...
            try:
                ...
                self.__failed_builds.add(
                    envName
                )  # potential bug where this doesn't happen, should use a finally clause
                # pass

    def _rebuild_all_code_envs(self):
        """x"""
        code_envs = self.__client.list_code_envs()
